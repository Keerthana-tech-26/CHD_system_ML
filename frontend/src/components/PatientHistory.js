              ...
              {entries.map((item) => (
                <li key={`diagnosis-${item._id}`} className="prediction-item">
                  <div className="prediction-detail">
                    <strong>Timestamp:</strong> {new Date(item.createdAt).toLocaleString()}
                  </div>
                  <div className="prediction-detail">
                    <strong>Prediction:</strong>
                    <span className={item.result === 1 ? "prediction-result at-risk" : "prediction-result not-at-risk"}>
                      {item.result === 1 ? "At Risk" : "Not at Risk"}
                    </span>
                  </div>
                  <div className="prediction-detail">
