  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok && result.result !== undefined && result.probability !== undefined) {
        ...
        console.log("✅ Diagnosis saved successfully, patient name stored for chatbot");
        navigate("/results");
      } else {
  ...
  return (
    <div className="diagnosis-form-container">
      ...
      <form onSubmit={handleSubmit} className="diagnosis-form">
        ...
        {/* Vital Signs Section */}
        <div className="form-section">
          <h3 className="section-title">🩺 Vital Signs & Clinical Measurements</h3>
          <div className="form-grid">
            <div className="form-group">
              <label>
        ...
        <div className="form-section">
          <h3 className="section-title">🤖 AI Model Selection</h3>
